...
case class Kanboard_Response_getAllUsers_Entries(name: String, username: String, notifications_enabled: String, is_ldap_user: String, id: String, google_id: Option[String], github_id: Option[String], email: String, role: String)
